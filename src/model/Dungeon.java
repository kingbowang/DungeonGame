...
/**
 * Implement dungeon interface that represents important methods
 * of the dungeon. This is the main body of the entire game.
 *
 * @author Pengbo Wang
 */
public interface Dungeon {
  ...
  /**
   * Implement a method that can get
   * the cell corresponding to the picture.
   *
  ...
  /**
   * Reuse the player who is in the dungeon
   * and set the player to the initial state.
   */
  void reuse();
}
