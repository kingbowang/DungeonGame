...
public interface DungeonController {
   ...
   *         can be smelled (Slight Smell), 2 means that a strong smell
   *         can be smelled (Terrible Smell)
   */
  int getOtyughs();
   ...
   */
  void startGame(Scanner in, Appendable out, String[] args) throws IOException, Exception;
